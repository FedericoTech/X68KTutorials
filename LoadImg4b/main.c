...
//Load LandScape BEGING
    ...
    buffer = (uint16_t *)_dos_malloc((415 * 415)/2);

    _dos_c_print("Loading Image\r\n");

    t = _dos_time_pr();

    _dos_read(file_handler, (char*)buffer, (414 * 414)/2);
...

    {
        ...
        // in 4 bits,   page 0 = 0, page 1 = 1, page 2 = 2, page 3 = 3
...

    {
        ...
        putbuf.buf_end = (void *) ((int)buffer + ((414 * 414)/2));
    ...
    // in 4 bits, 0 no pages,   page 0 = 1, 3  page 1 = 2, 4
    _iocs_vpage(3);   // we activate pages 0 and 1
