...
startp:
    move.l	sp,sp_work          ; save the stack into sp_work
...
thd_name:
    dc.b	'NEWZ',0
pw_msg:
    dc.b	'Please enter password(XXXX;X single-byte number) >',0
tm_msg:
    dc.b	'Please enter time(HH:MM; H:hour,M:minute) >',0
start_thd:
    dc.b	'Denied access',$0d,$0a,0
or_msg:
    dc.b	'File can not be opened.',$0d,$0a,0
    .stack
    ds.l	256
user:                       ; user SP
