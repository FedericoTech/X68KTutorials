...
int main(void)
{
    ...
    s_run[0] = loadData(NULL, "s_run_0.spt", fconf.config);
    s_run[1] = loadData(NULL, "s_run_1.spt", fconf.config);
    s_run[2] = loadData(NULL, "s_run_2.spt", fconf.config);
    s_run[3] = loadData(NULL, "s_run_3.spt", fconf.config);

    s_spin[0] = loadData(NULL, "s_spin_0.spt", fconf.config);
    s_spin[1] = loadData(NULL, "s_spin_1.spt", fconf.config);
    s_spin[2] = loadData(NULL, "s_spin_2.spt", fconf.config);
    s_spin[3] = loadData(NULL, "s_spin_3.spt", fconf.config);
    ...
    s_walk[0] = loadData(NULL, "s_walk_0.spt", fconf.config);
    s_walk[1] = loadData(NULL, "s_walk_1.spt", fconf.config);
    s_walk[2] = loadData(NULL, "s_walk_2.spt", fconf.config);
    s_walk[3] = loadData(NULL, "s_walk_3.spt", fconf.config);
    s_walk[4] = loadData(NULL, "s_walk_4.spt", fconf.config);
    s_walk[5] = loadData(NULL, "s_walk_5.spt", fconf.config);
...

    {
        ...
        status = _iocs_sp_regst(
            sp_register.flags.pcg | VERTICAL_BLANKING_NO_DETECT,    //int_ spno sprite number (0-127) //int_ mode bit 31 0: Vertical blanking interval detection post-setting 1: Not detected
            x + 16,                                  //int_ x X coordinates (0-1023 16 displayed on the far left
            y,                                  //int_ y Y " (" " Top ")
            sp_register.code,                   //code pattern code
            3                       //int_ prw priority
        );

        sp_register.flags.pcg = 2;        // pcg number
        status = _iocs_sp_regst(
            sp_register.flags.pcg | VERTICAL_BLANKING_DETECTION,    //int_ spno sprite number (0-127) //int_ mode bit 31 0: Vertical blanking interval detection post-setting 1: Not detected
            x + 32,                                  //int_ x X coordinates (0-1023 16 displayed on the far left
            y,                                  //int_ y Y " (" " Top ")
            sp_register.code,                   //code pattern code
            3                       //int_ prw priority
        );

        sp_register.flags.pcg = 3;        // pcg number
        status = _iocs_sp_regst(
            sp_register.flags.pcg | VERTICAL_BLANKING_NO_DETECT,    //int_ spno sprite number (0-127) //int_ mode bit 31 0: Vertical blanking interval detection post-setting 1: Not detected
            x,                                  //int_ x X coordinates (0-1023 16 displayed on the far left
            y + 16,                                  //int_ y Y " (" " Top ")
        ...
        sp_register.flags.pcg = 4;        // pcg number
        status = _iocs_sp_regst(
            sp_register.flags.pcg | VERTICAL_BLANKING_NO_DETECT,    //int_ spno sprite number (0-127) //int_ mode bit 31 0: Vertical blanking interval detection post-setting 1: Not detected
            x + 16,                                  //int_ x X coordinates (0-1023 16 displayed on the far left
            y + 16,                                  //int_ y Y " (" " Top ")
        ...
        sp_register.flags.pcg = 5;        // pcg number
        status = _iocs_sp_regst(
            sp_register.flags.pcg | VERTICAL_BLANKING_DETECTION,    //int_ spno sprite number (0-127) //int_ mode bit 31 0: Vertical blanking interval detection post-setting 1: Not detected
            x + 32,                                  //int_ x X coordinates (0-1023 16 displayed on the far left
            y + 16,                                  //int_ y Y " (" " Top ")
        ...
        sp_register.flags.pcg = 6;        // pcg number
        status = _iocs_sp_regst(
            sp_register.flags.pcg | VERTICAL_BLANKING_NO_DETECT,    //int_ spno sprite number (0-127) //int_ mode bit 31 0: Vertical blanking interval detection post-setting 1: Not detected
            x,                                  //int_ x X coordinates (0-1023 16 displayed on the far left
            y + 32,                                  //int_ y Y " (" " Top ")
        ...
        sp_register.flags.pcg = 7;        // pcg number
        status = _iocs_sp_regst(
            sp_register.flags.pcg | VERTICAL_BLANKING_NO_DETECT,    //int_ spno sprite number (0-127) //int_ mode bit 31 0: Vertical blanking interval detection post-setting 1: Not detected
            x + 16,                                  //int_ x X coordinates (0-1023 16 displayed on the far left
            y + 32,                                  //int_ y Y " (" " Top ")
        ...
        sp_register.flags.pcg = 8;        // pcg number
        status = _iocs_sp_regst(
            sp_register.flags.pcg | VERTICAL_BLANKING_DETECTION,    //int_ spno sprite number (0-127) //int_ mode bit 31 0: Vertical blanking interval detection post-setting 1: Not detected
            x + 32,                                  //int_ x X coordinates (0-1023 16 displayed on the far left
            y + 32,                                  //int_ y Y " (" " Top ")
